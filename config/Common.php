...
use PrestTEC\CodeIgniter_Cli\UserConfig;
...
class Common extends Config
{
    ...
    public function define(Container $di)
    {
        ...
        foreach ($this->commands as $command) {
            $class = 'PrestTEC\CodeIgniter_Cli\Command\\' . $command;
            $di->params[$class] = [
        ...
        $di->setter['PrestTEC\CodeIgniter_Cli\Command\Seed']['setSeederPath']
            = $seeder_path;
...
//        $logger = $di->get('aura/project-kernel:logger');
        ...
        foreach ($this->commands as $command) {
            ...
            $help_class = 'PrestTEC\CodeIgniter_Cli\Command\\' . $command . 'Help';
            $help_service->set(
                $command_name,
